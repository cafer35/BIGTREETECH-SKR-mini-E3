...
#define STRING_CONFIG_H_AUTHOR "(Carlos F., Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Carlos F."
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -28, -40, -1.85 }
